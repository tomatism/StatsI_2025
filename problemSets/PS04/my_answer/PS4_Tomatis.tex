...
\begin{enumerate}
	\item Ho states: $\hat{\beta}_{\text{adjacent\_yards}}$ = 0, meaning that the effect on Cuccinelli’s vote share of a precinct being adjacent to one assigned to have yard signs is zero.\\
...
\noindent Moreover, this value suggests that other factors not included in the model should be more deeply investigated and potentially incorporated.  
\end{document}
